...
public partial class SpacesDashboardView : UserControl
{
    ...
    private async Task LoadFavoritesAsync()
    {
        ...
        SetFavoritesStatus("Uèitavanje favorita...");
        ...
        try
        {
            ...
            if (selected.Count == 0)
            {
                ShowNoFavorites("Ovdje æe se prikazati favoriti kada oni budu oznaceni.");
                return;
            }

            TxtFavoritesTitle.Text = ucionice.Count > 0 ? "Favoriti uèionica" : "Favoriti teretana";
        ...
        {
            if (version != _loadVersion) return;
            ShowNoFavorites("Greška kod dohvaæanja favorita.");
        }
    }
