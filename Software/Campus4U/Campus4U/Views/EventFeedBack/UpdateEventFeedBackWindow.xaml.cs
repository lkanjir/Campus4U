...
namespace Client.Presentation.Views.EventFeedBack
{
    public partial class UpdateEventFeedBackWindow : Window
    {
        ...
        private void btnUpdateKomentar_Click(object sender, RoutedEventArgs e)
        {
            ...
            {
                MessageBox.Show("Komentar ne smije biti prazan. Potrebno je unijeti tekst!", "Greška", MessageBoxButton.OK, MessageBoxImage.Warning);
                return;
            }
            ...
            if (!uspjeh)
            {
                MessageBox.Show("Ažuriranje komentara nije uspjelo.", "Greška", MessageBoxButton.OK, MessageBoxImage.Error);
                return;
            }
